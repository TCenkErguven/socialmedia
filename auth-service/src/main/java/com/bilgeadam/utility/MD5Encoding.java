...
public class MD5Encoding {
    ...
    public static String convertMD5(String md5){
        try{
            //MessageDigest sınıfı getInstance metodu aracılığıyla içerisinde aldığı String formattaki algoritma isimlerine göre
            //şifreleme işlemi yapar. Bu algoritmalara örnek: SHA-1, SHA-2
            ...
            for(int i=0; i<array.length; i++){
                //--> & 0XFF, byter'in hexadecimal değerini almak için kullanılır. Ve byte'ın en düşük olan 8 bitini temsil eder.
                //
